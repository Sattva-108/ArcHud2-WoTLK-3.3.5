	...
	if(self.f.pulse) then
		...
		if(self.parent.db.profile.RingVisibility == 1 or self.parent.db.profile.RingVisibility == 3) then
			...
			if(self.parent.db.profile.RingVisibility == 3 and isInCombat) then
				...
				elseif(me == "TargetMana" and (UnitIsDead("target") or self.f.maxValue == 0) or me == "FocusMana" and (UnitIsDead("focus") or self.f.maxValue == 0)) then
				...
				if(string.find(me, "Mana") and me ~= "PetMana" and UnitPowerType(self.unit or self:GetParent().unit or "player") == 1 and self.f.maxValue > 0) then
